...
<body id="body" class="wrapper">
    <div id="top" style="margin:10px 0 0 0;padding:0 0 10px 0; border-bottom:solid 1px #919191;">
        <img src="http://i1.vanclimg.com/cms/20160119/logo_new.jpg" alt="凡客诚品" title="凡客诚品" onclick="javascript:window.location.href='/'" style="cursor:pointer" /></div>
    <!--logo-->
 ...
 <!-------------------------------------------------找回密码第一步star ---------------------------------------------------------->
  ...
  <div class="asRetrieve_pwContent"><p class="sprite_a pwContentTitle01"><span class="asfontnone">1.输入手机号</span></p>
  <span class="box30"></span>
    <form method="post" action="/forget2">
    
 
  <ul id="asRetrieve_pwList">
         <li><span class="editName">手机号：</span>
                <input type="text" name="phone" id="input_username" class="editInput" />
                <span class="box3"></span>
                <span class="v2reg_tips01" style="margin-left:210px;" id="div_username"></span> 
         </li>
         <li style="height:85px"><span class="editName" style="margin-top: 15px">验证码：</span>     
                <input id="input_validatecode" type="text" maxlength="6" class='editInput01' name="code" style="margin-top: 18px" />
